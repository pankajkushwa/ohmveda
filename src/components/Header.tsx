                  ...
                  <div className="absolute right-0 mt-2 w-48 bg-white border border-slate-200 rounded-xl shadow-xl p-2 z-50 text-slate-900 text-xs font-medium space-y-1">
                    ...
                    {onOpenAccountModal && (
                      <button
                        ...
                        className="w-full text-left p-2 rounded-lg hover:bg-slate-100 text-slate-800 font-bold flex items-center gap-2"
                      >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-white/95 backdrop-blur-md border-b border-slate-200 px-4 py-5 shadow-2xl max-h-[85vh] overflow-y-auto space-y-4 divide-y divide-slate-100"
          >
              ...
              <div className="pb-3 space-y-2">
                <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 flex items-center justify-between">
                  <div className="flex items-center gap-3 min-w-0">
                    <div className="w-9 h-9 rounded-full bg-blue-600 text-white font-extrabold flex items-center justify-center text-sm shadow-sm shrink-0">
                      {userProfile.name.charAt(0).toUpperCase()}
                    </div>
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg bg-rose-50 hover:bg-rose-100 text-rose-600 text-xs font-bold transition-colors shrink-0"
                    title="Log Out"
                  >
                ...
                {onOpenAccountModal && (
                  <button
                    ...
                    className="w-full py-2.5 px-3 rounded-xl bg-blue-50/80 hover:bg-blue-100 text-blue-700 border border-blue-200/80 text-xs font-bold flex items-center justify-center gap-2 transition-colors cursor-pointer"
                  >
            ...
            <div className="pt-3 flex flex-col gap-1.5">
              ...
              <button
                onClick={() => handleNavClick('home', 'hero')}
                className={`w-full px-4 py-3 rounded-xl text-xs font-bold text-left transition-all flex items-center justify-between cursor-pointer ${
                  currentPage === 'home' && activeSection === 'hero'
                    ? 'bg-blue-600 text-white shadow-xs'
              ...
              <div>
                ...
                >
                  <span className="flex items-center gap-2.5">
                    ...
                    <span>Hardware Products Catalog</span>
                  </span>
                    ...
                    >
                      {navProductCategories.length === 0 ? (
                        ...
                        navProductCategories.map((cat) => {
                          ...
                          return (
                            <div key={cat.id} className="space-y-1 bg-slate-50/80 p-2.5 rounded-xl border border-slate-200/80">
                              <button
                                onClick={() => handleCategoryNav(cat)}
                                className="w-full text-left py-1.5 px-2 rounded-lg text-xs font-extrabold text-slate-900 hover:text-blue-600 flex items-center justify-between transition-colors cursor-pointer"
                              >
                              ...
                              <div className="pl-3 space-y-1">
                                {cat.items.map((sub: any) => (
                                  <button
                                    ...
                                    className="w-full text-left py-1.5 px-2 rounded-md hover:bg-white text-[11px] font-medium text-slate-600 hover:text-blue-600 flex items-center justify-between group transition-colors cursor-pointer"
                                  >
              ...
              >
                <span className="flex items-center gap-2.5">
                  ...
                  <span>Electronics Component Store</span>
                </span>
                <ChevronRight className="w-4 h-4 opacity-50" />
              </button>
            ...
            <div className="pt-4 flex flex-col gap-2.5">
              {userProfile ? (
                <button
                  ...
                  className="w-full py-3 rounded-xl text-xs font-bold text-slate-800 bg-blue-50 hover:bg-blue-100 border border-blue-200 flex items-center justify-center gap-2 transition-colors cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full py-3 rounded-xl text-xs font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 border border-slate-200 flex items-center justify-center gap-2 transition-colors cursor-pointer"
                >
              ...
              <button
                ...
                className="w-full py-3 rounded-xl text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 flex items-center justify-center gap-2 shadow-sm transition-colors cursor-pointer"
              >
