            ...
            {activeTab === 'orders' && (
              selectedOrder ? (
                ...
                <div className="space-y-5 animate-fadeIn">
                  ...
                  {selectedOrder.orderStatus === 'Cancelled' && selectedOrder.paymentMethod === 'COD' && (
                    <div className="p-3.5 bg-slate-100 border border-slate-300 rounded-xl flex items-start gap-3 text-slate-900 text-xs shadow-2xs">
                      <XCircle className="w-4 h-4 text-slate-500 shrink-0 mt-0.5" />
                      <div>
                        <h4 className="font-black text-slate-950">Order Cancelled — No Refund Due (COD Order)</h4>
